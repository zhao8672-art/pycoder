...
async def _handle_write_file(params: dict, context: dict) -> dict:
    ...
    return {"success": True, "path": params["path"], "size": len(params["content"].encode())}
...
async def _handle_list_files(params: dict, context: dict) -> dict:
    ...
    return {"success": True, "path": params.get("path", "."), "items": items, "count": len(items)}
